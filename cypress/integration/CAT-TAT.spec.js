...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        ...
        cy.get('#email').type('elvercio@it.com')
  ...
  it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function() {
    ...
    it('exibe mensagem de erro quanto o telefone se torna obrigatório mas não é preenchido', function() {
        cy.get('#firstName').type('Elvercio')
        cy.get('#lastName').type('Neto')
        cy.get('#email').type('elvercio@it.com')
    ...
    it('seleciona um arquivo simulando um drad-and-drop', function(){ 
        cy.get('input[type="file"]')
